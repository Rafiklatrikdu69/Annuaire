...
// Utilise fgetc pour lire chaque caractère du fichier jusqu'à ce que, l'on atteind la fin du fichier
    ...
    while(cpt<ligne)
    {
        ...
        /*if(strlen( p[cpt].mel_p) == 0){
                printf("%s ",p[cpt].mel_p);
            assert(strlen( p[cpt].mel_p) != 0);
        }*/
